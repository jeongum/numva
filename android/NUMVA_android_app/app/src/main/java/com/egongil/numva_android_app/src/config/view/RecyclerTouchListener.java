package com.egongil.numva_android_app.src.config.view;
...
import com.egongil.numva_android_app.src.parkingmemo.interfaces.OnActivityTouchListener;
...
//        setIndependentViews(R.id.simple_memo_ll_additem);
